...
const Hero = () => {
  ...
  return (
    <section
      className="relative bg-cover min-h-screen overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="relative z-10 w-full h-screen flex items-center justify-center md:justify-start">
        <div className="text-center md:text-left px-6 sm:px-12 lg:pl-20 max-w-[800px]">
          ...
          <a
            href="#servicios"
            className="inline-block font-bold py-3 px-8 rounded-full text-sm sm:text-base md:text-lg font-roboto shadow-lg transition-all duration-300 transform hover:bg-[#CC0000] hover:text-[#001e33] hover:shadow-xl hover:scale-105 text-[#001e33]"
            style={{
