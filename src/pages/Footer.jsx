...
const Footer = () => {
    return (
        <footer className="bg-[#030912] text-white font-roboto pt-16 pb-6 border-t border-white/5">
            <div className="max-w-7xl mx-auto px-8 sm:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-10 lg:gap-12 mb-12">
                ...
                <div className="xl:col-span-2">
                    <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#d4af37] to-[#f5e27a] mb-4 font-montserrat tracking-tight">
                        Legal 360 S.A.S.
                    </h2>
                    <p className="text-gray-400 text-sm leading-relaxed mb-4 max-w-sm">
                        NIT. 901.938.444-1 <br />
                        Legal, claro y eficiente. Protege tu empresa con verdaderos expertos legales.
                    </p>
                    
                    {/* Redes Sociales Integradas */}
                    <div className="flex gap-4 mt-6">
                        <a href="https://www.instagram.com/legal360abogados/" target="_blank" rel="noopener noreferrer" className="bg-white/5 p-3 rounded-full hover:bg-[#e6d769] hover:text-[#001e33] text-gray-300 transition-all duration-300">
                            <FaInstagram className="text-xl" />
                        </a>
                        <a href="https://wa.link/twbzum" target="_blank" rel="noopener noreferrer" className="bg-white/5 p-3 rounded-full hover:bg-[#e6d769] hover:text-[#001e33] text-gray-300 transition-all duration-300">
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-gray-400 text-sm">
                        ...
                        <li className="hover:text-white transition-colors cursor-default">Cra. 23 # 79 - 09, Pereira</li>
                    </ul>
                </div>
            ...
            <div className="w-full border-t border-white/10 pt-6 mt-8">
                <div className="max-w-7xl mx-auto px-8 text-center sm:text-left text-xs text-gray-500 font-montserrat tracking-wide flex flex-col sm:flex-row justify-between items-center gap-2">
