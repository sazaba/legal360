        ...
        <section className="pt-32 pb-16 px-6 sm:px-10 font-sans min-h-screen bg-[#001e33] text-white">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="text-gray-100 space-y-4 text-base leading-relaxed">
                    ...
                    <p>
                        Sin perjuicio de lo consagrado en la legislación colombiana aplicable, LEGAL 360 S.A.S., no asume responsabilidad alguna, por daño o perjuicio derivado de la pérdida de información o utilidades, presencia de virus informáticos resultados del uso o la imposibilidad de usar el material de esta página web.
                    ...
                    <p>
                        ...
                        Así mismo, podrá radicar virtualmente, peticiones, quejas, reclamos, sugerencias o felicitaciones a través del correo electrónico servicioalcliente@legal360.co y podrá contactarnos en la Línea celular 3123240463.
                ...
                <div className="bg-white text-gray-800 rounded-xl shadow-md overflow-hidden flex flex-col lg:flex-row">
                    ...
                    <form className="w-full lg:w-1/2 p-6 space-y-4">
                        <div>
                            <label className="block font-semibold">Nombre completo *</label>
                            <input type="text" className="w-full p-2 rounded border border-gray-300" required />
                        </div>
                        <div>
                            <label className="block font-semibold">Correo electrónico *</label>
                            <input type="email" className="w-full p-2 rounded border border-gray-300" required />
                        </div>
                        <div>
                            <label className="block font-semibold">Teléfono</label>
                            <input type="tel" className="w-full p-2 rounded border border-gray-300" />
                        </div>
                        <div>
                            <label className="block font-semibold">Objeto de la solicitud *</label>
                            <select className="w-full p-2 rounded border border-gray-300" required>
                        ...
                        <div>
                            <label className="block font-semibold">Descripción (máx. 2000 caracteres) *</label>
                            <textarea maxLength="2000" rows="6" className="w-full p-2 rounded border border-gray-300" required></textarea>
                        </div>
                        <div>
                            <label className="block font-semibold">Anexar documentos (opcional)</label>
                            <input type="file" multiple accept=".jpg,.gif,.png,.doc,.xls,.txt,.pdf,.zip" className="w-full p-2" />
                            <small className="text-sm text-gray-500 block mt-1">Solo se permiten archivos de hasta 2MB. Evite caracteres especiales en el nombre del archivo.</small>
                        </div>
