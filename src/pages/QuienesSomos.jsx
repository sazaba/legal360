...
const QuienesSomos = () => {
  return (
    // 'isolate' crea un nuevo contexto de apilamiento en Safari, mejorando el rendimiento del blur
    <section className="relative w-full min-h-[100svh] flex items-center justify-center lg:justify-start px-6 sm:px-12 lg:px-24 py-32 overflow-hidden bg-[#0c111b] isolate">
      
      {/* 1. FONDO OPTIMIZADO (Sin JS, puro CSS) */}
      <div className="absolute inset-0 z-[-2]">
        <img
          src={Mari}
          alt="Equipo Legal 360"
          loading="lazy"
          className="w-full h-full object-cover object-[70%_center] lg:object-[85%_center] pointer-events-none"
        />
      </div>

      {/* 2. OVERLAYS INTELIGENTES */}
      {/* Móvil: degradado de abajo hacia arriba. Desktop: degradado de izquierda a derecha */}
      <div className="absolute inset-0 z-[-1] bg-gradient-to-t from-[#0c111b]/95 via-[#0c111b]/80 to-[#0c111b]/40 lg:bg-gradient-to-r lg:from-[#0c111b]/95 lg:via-[#0c111b]/80 lg:to-transparent mix-blend-multiply" />
      <div className="absolute inset-0 z-[-1] bg-[#001e33]/30" />

      {/* 3. SEPARADOR SUPERIOR (Conexión fluida con el Hero) */}
      <div className="absolute top-0 left-0 w-full overflow-hidden z-10 -translate-y-[1px]">
      ...
      {/* 4. CONTENIDO PRINCIPAL (Glassmorphism Card) */}
      <div className="relative z-20 w-full max-w-2xl mt-8 lg:mt-0">
        ...
        <div className="bg-[#001e33]/40 backdrop-blur-xl border border-white/10 rounded-3xl p-8 sm:p-12 shadow-[0_8px_32px_rgba(0,0,0,0.4)] transition-colors duration-500 hover:border-white/20 hover:bg-[#001e33]/50">
          ...
          {/* Footer de la tarjeta: Eslogan y Redes */}
      ...
      {/* 5. SEPARADOR INFERIOR (Conecta con la sección Servicios) */}
      <div className="absolute bottom-0 left-0 w-full overflow-hidden z-10 translate-y-[2px]">
